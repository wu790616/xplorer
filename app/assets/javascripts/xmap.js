function xmap(svg, topics, links, width, height) {
		...
		var node = svg.append("g")
									...
									.enter()
									.append("a")
									.attr("xlink:href", function(d) { return "http://0.0.0.0:3000/topics/"+d.base+"?center="+d.center+"&from="+d.from+"&page_num="+d.page })
									.attr("class", "nodes")
									.append("circle")
									.attr("r", topic_radius)
